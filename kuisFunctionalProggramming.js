...
function getProductsByCategory(products, category) {
    /**
     * Menggunakan metode array immutable untuk mengembalikan
     * array produk yang termasuk dalam kategori yang diberikan.
     */
...
function calculateTotalPrice(products) {
    /**
     * Menggunakan metode array immutable untuk menghitung
...
function applyDiscount(products, discount) {
    /**
     * Menggunakan metode array immutable untuk mengembalikan
     * array baru, di mana setiap produk memiliki harga yang
     * sudah dikurangi dengan diskon yang diberikan.
     */
    return products.map(product => ({
        ...product,
            price: product.price * (1 - discount / 100) // Menghitung harga setelah diskon
        }));
}
